  ...
  return (
    <div className="min-h-screen" data-testid="page-daftar">
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #065f46 0%, #064e3b 40%, #065f46 100%)",
        }}
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-green-300 font-semibold text-sm uppercase tracking-widest mb-3">
            Bergabung Sekarang
          </p>
          ...
          <p className="text-green-200 text-lg mt-4 leading-relaxed">
            Isi formulir pendaftaran di bawah ini dan segera amankan Kuota di
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-1 space-y-6">
              <div
                className="bg-gradient-to-br from-[#0f172a] to-[#1e3a5f] rounded-2xl p-6 text-white relative overflow-hidden"
                data-testid="price-info-card"
              >
                ...
                <div className="relative">
                  ...
                  <div className="font-serif font-bold text-4xl text-[#ffd700] mb-1">
                    Rp160.000
                  </div>
              ...
              <div
                className="bg-[#f5f7fa] rounded-2xl p-6 border border-[#b8860b]/15"
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <p className="font-bold text-[#0f172a] text-base tracking-wider">
                        5859 4592 5032 5727
                      </p>
                      <button
                    ...
                    {copied && (
                      <p className="text-green-600 text-xs mt-1">Tersalin!</p>
                    )}
                  </div>
                  <div>
                    <p className="text-gray-500 text-xs uppercase tracking-wide mb-1">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-3">
                    ...
                    <p className="text-yellow-700 text-xs leading-relaxed">
                      Tambahkan kode unik <strong>550</strong> di akhir nominal
                      pembayaran:
                    </p>
                    <p className="text-yellow-800 font-bold text-sm mt-1">
                      Contoh: Rp 160<strong>.550</strong>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <h4 className="font-serif font-bold text-[#0f172a] text-base mb-3">
                  Butuh Bantuan?
                </h4>
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-3 text-sm text-gray-600 hover:text-[#b8860b] transition-colors"
                    data-testid="form-contact-wa"
                  >
            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                >
                  ...
                  <h2 className="font-serif text-2xl font-bold text-green-800 mb-3">
                    Pendaftaran Berhasil!
                  </h2>
                  <p className="text-green-700 text-base leading-relaxed mb-4">
                    Data pendaftaran kamu telah berhasil dikirim. Tim Widya
                    Nusantara Academy akan segera memproses data kamu.
                  </p>
                  {emailSent ? (
                    <div className="bg-green-100 border border-green-300 rounded-xl p-4 mb-6 max-w-md mx-auto">
                      ...
                      <p className="text-green-700 text-xs">
                        Silakan cek email kamu untuk melihat konfirmasi
                        pendaftaran beserta invoice pembayaran.
                      </p>
                    </div>
                  ) : (
                    <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-4 mb-6 max-w-md mx-auto">
                      <p className="text-yellow-800 font-semibold text-sm mb-1">
                        Email Konfirmasi Gagal Terkirim
                      </p>
                      <p className="text-yellow-700 text-xs">
                        Data pendaftaranmu sudah tersimpan, tapi email
                        konfirmasi gagal dikirim. Silakan hubungi admin melalui
                        WhatsApp.
                      </p>
                    </div>
                  )}
                  <p className="text-green-600 text-sm">
                    Kami akan menghubungi kamu melalui WhatsApp dalam 1-2 hari
                    kerja.
                  </p>
                  <button
                    onClick={() => {
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm mb-6">
                    Isi semua data dengan lengkap dan benar. Data yang tidak
                    ...
                    >
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                className="h-11 border-gray-200 focus:border-[#b8860b] focus:ring-[#b8860b]"
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                className="h-11 border-gray-200 focus:border-[#b8860b]"
                              ...
                              <FormControl>
                                <div className="relative">
                                  ...
                                  <Input
                                    ...
                                    {...field}
                                    className="h-11 pl-7 border-gray-200 focus:border-[#b8860b]"
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                        <p className="text-blue-700 text-xs leading-relaxed">
                          Dengan mendaftar, kamu menyetujui syarat dan ketentuan
                          Widya Nusantara Academy. Data kamu akan digunakan
                          untuk keperluan administrasi pendaftaran saja.
                        </p>
                      </div>
                      ...
                      <p className="text-center text-gray-400 text-xs">
                        Data kamu akan tersimpan dan email konfirmasi akan
                        dikirim otomatis
                      </p>
                    </form>
                  </Form>
      ...
      <section
        className="py-12 bg-[#f5f7fa] text-center"
        data-testid="section-thankyou"
      >
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <p className="text-gray-500 text-sm leading-relaxed">
            Terima kasih, kamu telah mendaftar di{" "}
            <strong className="text-[#0f172a]">Widya Nusantara Academy</strong>.
            Jangan lupa pantau selalu website kami di{" "}
            <a
              href="www.widyautbk.site"
              target="_blank"
              rel="noopener noreferrer"
